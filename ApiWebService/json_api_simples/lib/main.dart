...
class _TarefasPageState extends State<TarefasPage>{
  ...
  // endereço da API
  final String baseUrl = "http://10.109.197.3:3009/tarefas";
  ...
  void _atualizarTarefa(String id,bool concluida) async {
    try {
      //cria um objeto -> tarefa
      final tarefa = {"concluida":!concluida}; //inverte o valor
      //faz o put http
            ...
            Expanded(
              ...
              : ListView.builder(
                ...
                itemBuilder: (context, index){
                  ...
                  return ListTile(
                    leading: Checkbox(value: tarefa["concluida"], onChanged: (value) => _atualizarTarefa(tarefa["id"], tarefa["concluida"])),
